...
class Minitaur:
  ...
  def resetPose(self):
    ...
    p.resetJointState(self.quadruped, self.jointNameToId['knee_front_leftR_joint'],
                      self.motorDir[1] * kneeangle)
    p.createConstraint(self.quadruped, self.jointNameToId['knee_front_leftR_joint'], self.quadruped,
    ...
    p.setJointMotorControl2(bodyIndex=self.quadruped,
                            jointIndex=self.jointNameToId['knee_front_leftR_joint'],
                            controlMode=p.VELOCITY_CONTROL,
                            targetVelocity=0,
                            force=kneeFrictionForce)
    ...
    p.resetJointState(self.quadruped, self.jointNameToId['knee_back_leftR_joint'],
    ...
    p.setJointMotorControl2(bodyIndex=self.quadruped,
                            ...
                            force=kneeFrictionForce)
    p.setJointMotorControl2(bodyIndex=self.quadruped,
                            jointIndex=self.jointNameToId['knee_back_leftR_joint'],
                            controlMode=p.VELOCITY_CONTROL,
                            targetVelocity=0,
                            force=kneeFrictionForce)
    ...
    p.resetJointState(self.quadruped, self.jointNameToId['knee_front_rightR_joint'],
    ...
    p.setJointMotorControl2(bodyIndex=self.quadruped,
                            ...
                            force=kneeFrictionForce)
    p.setJointMotorControl2(bodyIndex=self.quadruped,
                            jointIndex=self.jointNameToId['knee_front_rightR_joint'],
                            controlMode=p.VELOCITY_CONTROL,
                            targetVelocity=0,
                            force=kneeFrictionForce)
    ...
    p.resetJointState(self.quadruped, self.jointNameToId['knee_back_rightR_joint'],
